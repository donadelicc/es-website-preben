...
const Footer = () => {
  ...
  const links = [
    ...
    { label: "Søk", href: "/sok", isButton: true }, // ✅ Moved Søk into links
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start pb-6 border-b border-gray-300">
            ...
            <div className="mb-4 md:mb-0">
              <Image src="/NSE.png" alt="NSE Logo" width={180} height={60} />
            </div>

            {/* ✅ Navigation */}
            <nav className="w-full md:w-auto" aria-label="Main Navigation">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <p className="text-gray-600">+47 73 59 36 09</p>
              <Link
            ...
            <div>
              ...
              <p className="text-gray-600">Sem Sælands Vei 1</p>
              <p className="text-gray-600">7034, Trondheim</p>
            </div>
